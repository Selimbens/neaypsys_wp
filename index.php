            ...
            <div class="fixed-wrapper">
                ...
                <div class="fixed-block block-right">
                    <ul class="list-unstyled social-icons">
                        ...
                        <li><a href="#" target="_blank"><i class="icon ion-logo-linkedin"></i></a></li>
                    </ul>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="section-heading page-heading">
                                            <p class="section-description">Faisons connaissance</p>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-12 col-lg-7 info-content">
                                        <div class="content-block">
                                            ...
                                            <h6 class="content-title">NEAPSYS, l’expertise humaine au service de votre technologie</h6>
                                            <div class="content-description">
                                                <p>
                                                    NEAPSYS est une société experte et indépendante dans le conseil IT, nos consultants développent pour nos clients des solutions digitales sur mesures et maîtrisent l’intégration des solutions de gestion d’entreprises ERP notamment SAP et SAGE. Nous allons libérer votre potentiel numérique, vous aider à être plus compétitif rapidement pour que le digital soit un levier de croissance et non pas un frein!
                                                </p>
                                                <p>
                                                    La valeur de Neapsys ceux sont nos collaborateurs, des développeurs, chefs de projet et managers qui réalisent dans les règles de l’art et l’innovation vos développements techniques et fonctionnels, tests, recettes, déploiement et maintenance pour intégrer vos processus dans des solutions digitales. Pour cela nous détectons, recrutons et formons en continue pour vous des talents en ingénierie IT.
                                                </p>
                                                <p>
                                                    Neapsys est une structure à taille humaine où chaque mission est appréhender avec toute l’énergie et l’expertise possible pour la réussite de vos projets. Nous collaborons avec nos clients en conservant un sens de l’écoute accru.
                                                </p>
                                                <p>
                                                    Nous sommes présents en France et en Tunisie, nous travaillons en mode projet ou en mode régie, dans un mode agile, depuis la conception jusqu’à l’exploitation de vos solutions.
                                                </p>
                                            </div>
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-12 col-md-6 single-info"><span>From:</span>
                                          <p>Lagos, Nigeria</p>
                                            ...
                                            <div class="d-block d-sm-flex align-items-center"><a class="btn content-download button-main button-scheme" href="#" onclick="download" role="button" download="David Emaye CV">Download CV</a>
                                                <ul class="list-unstyled list-inline content-follow">
                                                    <li class="list-inline-item"><a href="#" target="_blank"><i class="icon ion-logo-twitter"></i></a></li>
                                                    <li class="list-inline-item"><a href="#" target="_blank"><i class="icon ion-logo-instagram"></i></a></li>
                                                    <li class="list-inline-item"><a href="#" target="_blank"><i class="icon ion-logo-linkedin"></i></a></li>
                                                    <li class="list-inline-item"><a href="#" target="_blank"><i class="icon ion-logo-facebook"></i></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4">
                                            <div class="single-service"><i class="icon service-icon ion-logo-css3"></i>
                                                <h6 class="service-title">Digital:</h6>
                                                <p class="service-description">
                                                    Nous travaillons de façon agile pour que vos spécifications fonctionnelles et techniques correspondent toujours à vos besoins et vos ambitions numériques, grâce à des méthodes itératives et incrémentales ( Sprint) pour suivre en continu l’évolution de la prestation</br>
                                                </p>
                                            </div>
                                        </div>
                                        <!-- Single service-->
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4">
                                            <div class="single-service"><i class="icon service-icon ion-logo-ionic"></i>
                                                <h6 class="service-title">Infrastructure:</h6>
                                ...
                                <div class="my-slider">
                                        ...
                                        <div class="single-review swiper-slide">
                                            <div class="review-header d-flex justify-content-between">
                                                <div class="review-client">
                                                    <div class="media"><img class="img-fluid rounded-circle client-avatar" src="<?php echo (get_template_directory_uri()); ?>/img/client-1.jpg" alt="Client">
                                    ...
                                    <div class="slider-item">
                                        ...
                                        <div class="single-review swiper-slide">
                                            <div class="review-header d-flex justify-content-between">
                                                <div class="review-client">
                                                    <div class="media"><img class="img-fluid rounded-circle client-avatar" src="<?php echo (get_template_directory_uri()); ?>/img/client-2.jpg" alt="Client">
                                                        <div class="client-details">
                                    ...
                                    <div class="slider-item">
                                        ...
                                        <div class="single-review swiper-slide">
                                            <div class="review-header d-flex justify-content-between">
                                                <div class="review-client">
                                                    <div class="media"><img class="img-fluid rounded-circle client-avatar" src="<?php echo (get_template_directory_uri()); ?>/img/client-3.jpg" alt="Client">
                                                        <div class="client-details">
                        ...
                        <div class="lightbox-content">
                            ...
                            <div class="container-fluid">
                                <div class="single-section">
                                    <div class="row align-items-center">
                                        <div class="col-12 col-lg-6 img-part">
                                            <img src="<?php echo (get_template_directory_uri()); ?>/img/post-5.jpg" alt="">
                                        </div>
                                ...
                                <div class="single-section">
                                    <div class="row align-items-center">
                                        <div class="col-12 col-lg-6 img-part">
                                            <img src="<?php echo (get_template_directory_uri()); ?>//img/post-3.jpg" alt="">
                                        </div>
                                        <div class="col-12 col-lg-6 content-part">
                                            <h3 class="content-title">Take a tour of my office</h3>
                                            <p class="content-description">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quod molestias adipisci suscipit aspernatur ut, laborum voluptate, iste quidem mollitia, molestiae nostrum id amet necessitatibus temporibus. Excepturi inventore odio rem itaque!</p>
                                ...
                                <div class="single-section">
                                    <div class="row align-items-center">
                                        <div class="col-12 col-lg-6 img-part">
                                            <img src="<?php echo (get_template_directory_uri()); ?>//img/post-6.jpg" alt="">
                                        </div>
                                        <div class="col-12 col-lg-6 content-part">
                                            <h3 class="content-title">Take a tour of my office</h3>
                                            <p class="content-description">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quod molestias adipisci suscipit aspernatur ut, laborum voluptate, iste quidem mollitia, molestiae nostrum id amet necessitatibus temporibus. Excepturi inventore odio rem itaque!</p>
                            ...
                            <div class="blog-section single-section">
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-4">
                                        <div class="card single-post">
                                            <a class="post-img" href="#0">
                                                <img class="card-img-top" src="<?php echo (get_template_directory_uri()); ?>/img/post-1.jpg" alt="Blog post">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-4">
                                        <div class="card single-post">
                                            <a class="post-img" href="#0">
                                                <img class="card-img-top" src="<?php echo (get_template_directory_uri()); ?>/img/post-2.jpg" alt="Blog post">
                                                <span class="content-date">11 Dec, 20</span>
                                            </a>
                                            <div class="card-body post-content">
                                                <a href="#0">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-4">
                                        <div class="card single-post">
                                            <a class="post-img" href="#0">
                                                <img class="card-img-top" src="<?php echo (get_template_directory_uri()); ?>/img/post-3.jpg" alt="Blog post">
                                                <span class="content-date">11 Dec, 20</span>
                                            </a>
                                            <div class="card-body post-content">
                                                <a href="#0">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-4">
                                        <div class="card single-post">
                                            <a class="post-img" href="#0">
                                                <img class="card-img-top" src="<?php echo (get_template_directory_uri()); ?>/img/post-4.jpg" alt="Blog post">
                                                <span class="content-date">11 Dec, 20</span>
                                            </a>
                                            <div class="card-body post-content">
                                                <a href="#0">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-4">
                                        <div class="card single-post">
                                            <a class="post-img" href="#0">
                                                <img class="card-img-top" src="<?php echo (get_template_directory_uri()); ?>/img/post-5.jpg" alt="Blog post">
                                                <span class="content-date">11 Dec, 20</span>
                                            </a>
                                            <div class="card-body post-content">
                                                <a href="#0">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-4">
                                        <div class="card single-post">
                                            <a class="post-img" href="#0">
                                                <img class="card-img-top" src="<?php echo (get_template_directory_uri()); ?>/img/post-6.jpg" alt="Blog post">
                                                <span class="content-date">11 Dec, 20</span>
                                            </a>
                                            <div class="card-body post-content">
                                                <a href="#0">
